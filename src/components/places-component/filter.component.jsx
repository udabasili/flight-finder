...
import { setPlaceFilter, } from '../../redux/places/place.actions';
import { placesCount } from '../../redux/places/place.selectors';


function Filter({placeNum, setPlaceFilter}) {
    ...
    return (
        <div className='filter'>
            <div className='filter__result'>
                <h2 className='header-2'>{placeNum} Results</h2>
            </div>
